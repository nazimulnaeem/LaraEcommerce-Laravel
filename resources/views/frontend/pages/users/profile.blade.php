...
@extends('frontend.pages.users.partials.master')
...
<div class="card-body">
                    <form method="POST" action="{{ route('user.profile.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="shipping_address" type="text" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address" rows="4" value="" autocomplete="shipping_address">{{ $user->shipping_address }}</textarea>
